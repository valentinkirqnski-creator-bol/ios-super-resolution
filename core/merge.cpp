...
// 832f7b8's kernel-sharpness cap (Config::merge_soften_inv_cov): rescale
// the inverse covariance when its largest entry exceeds 32, so no kernel
// gets sharper than sigma ~ 1/sqrt(32) ~ 0.18 raw px; non-finite entries
// (raw 1/det on a singular comp cov) fall back to the sigma ~ 0.7 iso.
